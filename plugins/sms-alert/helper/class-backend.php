    ...
    public function smsalertReview()
    {
        ...
        if ('1' === $show && '0' === $remind && $current_date > $show_date ) {
            ...
            ?>
                    ...
                    <span>
                        <a href="javascript:void(0)" class="smsalert-review sa-delete-btn alignright" option="remind-later"><span class="dashicons dashicons-dismiss"></span><?php esc_html_e('Dismiss', 'sms-alert'); ?></a>
                    </span>
                </p>
                <p>
                    <span>
            <?php
             ...
             echo wp_kses_post(sprintf(__('Or else, please leave us a support question in the forum. We\'ll be happy to assist you: <a href="%s">Get support</a> &nbsp;&nbsp; <a href="javascript:void(0)" class="smsalert-review" option="not-show-again">Don\'t show again</a>', 'sms-alert'), 'https://wordpress.org/support/plugin/sms-alert'));
            ?>
                    </span>
                </p>
            </div>
